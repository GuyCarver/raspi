...
class sentrybot(object):
  ...
  _MACHINEGROUP = 2                             #Sound group for machine sounds.
  _speeds = (.25, .5, 1.0)
...
#    GPIO.output(sentrybot._laser, GPIO.HIGH)
    ...
    self._torsosound = sound('torso2', sentrybot._MACHINEGROUP)
...
#            print("Clamping delta: ", delta)
      ...
      c = sound('sys/corrupt', 1)               #Play corruption audio.
      c.play()
      print("Error!")
      raise e
    finally:
